...
public class S3Application {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //deleting bucket
        awsService.deleteBucket("maixuanviet-bucket-test2");
        ...
        DeleteObjectsRequest delObjReq = new DeleteObjectsRequest("maixuanviet-bucket")
          .withKeys(objkeyArr);
