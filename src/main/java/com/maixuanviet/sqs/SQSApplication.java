...
public class SQSApplication {
    ...
    public static void main(String[] args) {
        ...
        CreateQueueRequest createStandardQueueRequest = new CreateQueueRequest("maixuanviet-queue");
        ...
        CreateQueueRequest createFifoQueueRequest = new CreateQueueRequest("maixuanviet-queue.fifo").withAttributes(queueAttributes);
        ...
        String deadLetterQueueUrl = sqs.createQueue("maixuanviet-dead-letter-queue")
            .getQueueUrl();
        ...
        SendMessageRequest sendMessageFifoQueue = new SendMessageRequest().withQueueUrl(fifoQueueUrl)
            ...
            .withMessageGroupId("maixuanviet-group-1")
            .withMessageAttributes(messageAttributes);
